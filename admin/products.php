                        ...
                        <tr>
                            ...
                            <td>
                                <div style="display: flex; align-items: center; gap: 8px;">
                                    ...
                                    <?php if ($product['status'] === 'approved'): ?>
                                        <a href="product_invoice.php?id=<?php echo $product['product_id']; ?>" class="btn btn-sm btn-invoice" title="View Invoice" target="_blank">
                            ...
                            <td>
                                <div style="display: flex; gap: 8px;">
                                    ...
                                    <!-- Change product photo (any farmer's product) -->
                                    <form method="POST" action="product_image_action.php" enctype="multipart/form-data" style="display: inline;">
                                        <input type="hidden" name="product_id" value="<?php echo $product['product_id']; ?>">
                                        <input type="file" name="product_image" id="adminProductImage<?php echo $product['product_id']; ?>"
                                               accept="image/jpeg,image/png,image/gif,image/webp"
                                               style="display: none;" onchange="this.form.submit();">
                                        <label for="adminProductImage<?php echo $product['product_id']; ?>"
                                               class="btn btn-sm btn-outline" style="margin: 0; cursor: pointer;"
                                               title="<?php echo $product['product_image'] ? 'Change photo' : 'Add photo'; ?>">
    ...
    <div class="modal-content" style="max-width: 700px;">
        ...
        <div class="modal-body">
            ...
            <div style="margin-top: 24px; padding-top: 24px; border-top: 1px solid var(--gray-200); display: flex; gap: 12px; justify-content: flex-end;">
                ...
                <?php if ($reviewProduct['status'] === 'approved'): ?>
                    <a href="product_invoice.php?id=<?php echo $reviewProduct['product_id']; ?>" class="btn btn-invoice" target="_blank">
