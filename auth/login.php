...
<body class="auth-page">
    ...
    <div class="auth-card">
        ...
        <form action="login_action.php" method="POST" data-validate>
            ...
            <?php // Hidden on localhost to match login_action.php, which skips
                  // the check for loopback requests. Shown normally elsewhere. ?>
            <?php if (!in_array($_SERVER['REMOTE_ADDR'] ?? '', ['127.0.0.1', '::1'], true)): ?>
                <div class="form-group">
                    <div class="g-recaptcha" data-sitekey="6LdC5zYsAAAAADN7DxbwQdWnTnDM5lE7_p0fCcnu"></div>
                </div>
            <?php endif; ?>
