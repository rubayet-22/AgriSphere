...
// Get cart items with product and farmer details (C++ backend: /api/cart/list)
$cartResponse = AgriSphereBackend::tryCall('/api/cart/list', [
    'customer_id' => (int)$customerId,
]);
$cartItems = $cartResponse['items'] ?? [];

// Totals are computed by the backend alongside the listing
            ...
            <div class="card">
                ...
                <div class="cart-items">
                    <?php foreach ($cartItems as $item):
                        ...
                        $hasDiscount = (int)($item['has_discount'] ?? 0) === 1;
                            ...
                            <div class="cart-item-details">
                                ...
                                <div class="cart-item-price-row">
                                    <div class="cart-item-unit-price">
                                        ...
                                        <?php endif; ?>
                                        <?php echo formatCurrency($unitPrice); ?> / <?php echo sanitize($item['unit']); ?>
                                    </div>
