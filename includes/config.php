...
// =====================================================
// NOTE: The C++ backend reads the same values from backend/config/backend.ini.
// If you change the credentials here, change them there as well.
...
// C++ Backend Service
// =====================================================
// The persistent C++ application layer that owns the Singleton
// DatabaseManager. Started with backend\start_backend.bat.
// BACKEND_API_KEY must match [server] api_key in backend/config/backend.ini.
define('BACKEND_URL', 'http://127.0.0.1:8787');
define('BACKEND_API_KEY', 'agrisphere-local-dev-key');
define('BACKEND_CONNECT_TIMEOUT', 2);   // seconds
define('BACKEND_TIMEOUT', 15);          // seconds
