...
// Unread notifications written by the C++ Observer layer
$unreadNotifications = isLoggedIn() ? getUnreadNotificationCount(getCurrentUserId()) : 0;
?>
<!-- Sidebar -->
<aside class="sidebar">
    ...
    <nav class="sidebar-nav">
        ...
        <a href="<?php echo BASE_URL; ?>customer/packages.php"
        ...
        <a href="<?php echo BASE_URL; ?>customer/notifications.php"
           class="sidebar-nav-item <?php echo $currentPage === 'notifications' ? 'active' : ''; ?>">
            <i class="fas fa-bell"></i>
            <span>Notifications</span>
            <?php if ($unreadNotifications > 0): ?>
                <span class="sidebar-nav-badge"><?php echo $unreadNotifications; ?></span>
            <?php endif; ?>
        </a>

        <a href="<?php echo BASE_URL; ?>customer/premium.php"
